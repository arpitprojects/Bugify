...
class CreateList extends Component {
    ...
    return (
        <div>
            <Button onClick={this.onOpenModal} className="btn-modal">Add another Card</Button>
            ...
            <Grid container spacing={3}>
                ...
                onChange={(e) => this.handleChange(e)}
                name="Created by" value={this.state['Created by']}
                >
                    {
                        namesListing.map((x , index) => {
                            return   <MenuItem value={x.id} key={index}>
            ...
            /> */}
                ...
                value={this.state['Associated Features']}
                >
                    {
